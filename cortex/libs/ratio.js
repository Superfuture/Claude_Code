...
var Ratio = function (a, b, alwaysReduce) {	
    if(!(this instanceof Ratio)){
		...
		if (a instanceof Ratio && b === undefined) {
			this.divSign = a.divSign;
			this.alwaysReduce = a.alwaysReduce;
...
Ratio.getNumeratorWithSign = function (top, bottom) {
		return ((top >= 0) == (bottom >= 0)) ? top : -Math.abs(top);
};
/**
...
Ratio.prototype.subtract = function (obj, obj2) {
    ...
    return this.add(obj.clone().negate());
};
/**
